...
const Application = () => {
    ...
    const {history, textArea, setTextArea} = useStateContext()
                ...
                (editor) ?
                    <>
                        <div className='container mx-auto px-4 flex flex-col min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8 text-sm'>
                            < div className='text-2xl font-bold pb-2 pr-[20rem]' >
                            ...
                            <form method='POST' onSubmit={handleSubmit}>
                                <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                                    ...
                                    <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                        ...
                                        <textarea id="editor" rows="8" className="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." value={textArea} onChange={handleChange} required></textarea>
                                    </div>
                                </div>
                                <button
